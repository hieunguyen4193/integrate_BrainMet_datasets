...
##### to re-run samples
#> "GSE186344_GSM5645911" <<< turn off process s6
#> "GSE193745_GSE193745"  <<< unknown error: Error in `[.data.frame`(feature.names, , gene.column) : undefined columns selected
#> "GSE200218_GSM6022252" 
#> "GSE200218_GSM6022253" 
#> "GSE200218_GSM6022254" 
#> "GSE200218_GSM6022255" 
#> "GSE234832_GSM7475326" <<< turn off process s6

# sample.id <- "GSE193745_GSE193745"
tmp.list.of.samples <- c(
                         "GSE140393_GSM4160579", 
                         "GSE140393_GSM4160581",
                         "GSE140393_GSM4160578",
                         "GSE140393_GSM4160580")
for (sample.id in tmp.list.of.samples){
